<h2><a href="https://www.geeksforgeeks.org/problems/minimum-cost-to-fill-given-weight-in-a-bag1956/1?_gl=1*rbtaoz*_up*MQ..&gclid=Cj0KCQjw_IXQBhCkARIsADqELbL27U9CiyFhfjk7oCYY-nMlPGxmPJgk1uGML882tyenAh-uirb8ey8aAp7mEALw_wcB&gbraid=0AAAAAC9yBkD5BKzLAdIM4gNgLHZTPbJ5v">Minimum Cost to Fill Given Weight</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given a bag of size w kg and you are provided costs of packets different weights of oranges in array cost[], find the minimum total cost to buy exactly w kg oranges<br></span></p>
<ul>
