<h2><a href="https://www.geeksforgeeks.org/problems/secret-cipher--141631/1?_gl=1*13mt4bc*_up*MQ..&gclid=Cj0KCQjw_IXQBhCkARIsADqELbL27U9CiyFhfjk7oCYY-nMlPGxmPJgk1uGML882tyenAh-uirb8ey8aAp7mEALw_wcB&gbraid=0AAAAAC9yBkD5BKzLAdIM4gNgLHZTPbJ5v">Secret Cipher</a></h2><h3>Difficulty Level : Difficulty: Hard</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p class="PDq2pG_selectionAnchorContainer" data-start="23" data-end="177"><span style="font-size: 14pt;">Geek wants to send a secret message to his friend Keeg. Instead of sending the original message directly, he encrypts it by inserting the character '*'.</span></p>
